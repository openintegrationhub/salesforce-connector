...
const {
  getOrganizations, getAccessToken, getMetadata, getElementDataFromResponse, dataAndSnapshot,
...
async function processAction(msg, cfg, snapshot = {}) {
  try {
    ...
    newElement.data = getElementDataFromResponse(arraySplittingKey, accounts);
    if (skipSnapshot) {
