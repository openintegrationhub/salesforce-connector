...
async function processAction(msg, cfg) {
  try {
    ...
    if (cfg.devMode) console.log('Dropping currently not supported fields in: MailingAddress, OtherAddress, ShippingAddress');

    delete transformedMessage.data.MailingAddress;
    delete transformedMessage.data.OtherAddress;
    delete transformedMessage.data.ShippingAddress;
