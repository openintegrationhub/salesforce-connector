...
function personToOih(contact) {
  ...
  if ('HasOptedOutOfFax' in contact && contact.HasOptedOutOfFax !== null) {
    person.categories.push({
      label: contact.HasOptedOutOfFax,
  ...
  if ('HasOptedOutOfEmail' in contact && contact.HasOptedOutOfEmail !== null) {
    person.categories.push({
      label: contact.HasOptedOutOfEmail,
  ...
  if (contact.AccountId) {
    person.relations.push({
      ...
      label: 'Employee',
      partner: {
        name: (String(contact.AccountId)),
      },
      uids: [contact.Id, (String(contact.AccountId))],
    });
  }
  ...
  if (contact.ReportsToId) {
    person.relations.push({
      ...
      label: 'Reports to',
      partner: {
        name: (String(contact.ReportsToId)),
      },
      uids: [contact.Id, (String(contact.ReportsToId))],
    });
  }
